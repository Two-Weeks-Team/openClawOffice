...
export const API_ERROR_CODES = {
  ...
  replayIndexReadFailed: "REPLAY_INDEX_READ_FAILED",
  replaySnapshotNotFound: "REPLAY_SNAPSHOT_NOT_FOUND",
  replaySnapshotReadFailed: "REPLAY_SNAPSHOT_READ_FAILED",
  replaySnapshotBadRequest: "REPLAY_SNAPSHOT_BAD_REQUEST",
